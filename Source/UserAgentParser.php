 ...
 */
namespace JesseGDonat\UserAgentParser;
...
class UserAgentParser{
	...
	/**
	 * Browser version
	 * @var string $_browserVersion
	 */
	protected static $_browserVersion;
	...
	/**
	 * Sets user agent variables
	 * @param string|null $u_agent User agent string to parse or null. Uses $_SERVER['HTTP_USER_AGENT'] on NULL
	 * @throws InvalidArgumentException on not having a proper user agent to parse.
	 * 	 */
	static protected function _parseUA( $u_agent = null ) {
		if( is_null($u_agent) ) {
